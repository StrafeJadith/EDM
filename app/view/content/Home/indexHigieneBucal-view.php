        ...
        <div class="contenedorprincipal">
                ...
                <div class="productos">
                    ...
                    <div class="productossubtitulo">
                        <details>
                            ...
                            <br>
                            <ul>
                                <li><a href="proteinas/">Proteinas</a></li>
                                <li><a href="verduras/">Verduras y Frutas</a></li>
                                <li><a href="granos/">Granos</a></li>
                            </ul>
                        </details>
                    </div>
                </div>
            ...
            <div class="proteina">
                ...
                <div class="productoscatalogo">
                    ...
                    <center>
                        <?php
                        $sql = $insLogin->ejecutarConsulta("SELECT * FROM productos p WHERE p.Categoria_Pro = 'BUCAL'");
